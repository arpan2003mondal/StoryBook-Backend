...
public class EmailService {
    ...
    /**
     * Send registration OTP email to user
     * 
    ...
    public void sendOtpEmail(String recipientEmail, String otp)
        ...
        String htmlContent = buildRegistrationOtpEmailContent(otp);
     ...
     * @throws UnsupportedEncodingException if encoding is not supported
     */
    public void sendForgotPasswordOtpEmail(String recipientEmail, String otp)
            throws MessagingException, UnsupportedEncodingException {
        MimeMessage message = mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
        ...
        helper.setFrom(fromEmail, appName);
        helper.setTo(recipientEmail);
        helper.setSubject(appName + " - Forgot Password OTP");

        String htmlContent = buildForgotPasswordOtpEmailContent(otp);
        helper.setText(htmlContent, true);
    ...
    private String buildWelcomeEmailContent(String userName, String userEmail) {
        // Use string concatenation instead of .formatted() to avoid issues with CSS
        // color codes
        return "<html>\n" +
                ...
                "            <h1 style=\"color: #667eea; margin: 0; font-size: 28px;\">Welcome to " + appName
                + "! 🎉</h1>\n" +
    ...
    /**
     * Build HTML content for registration OTP email
     */
    private String buildRegistrationOtpEmailContent(String otp) {
        // Use string concatenation instead of .formatted() to avoid issues with CSS
        // color codes
        return "<html>\n" +
                ...
                "            <p style=\"color: #999; margin: 5px 0 0 0;\">Registration OTP</p>\n" +
                "        </div>\n" +
                "        \n" +
                "        <p style=\"color: #333; font-size: 16px; margin-bottom: 20px;\">\n" +
                "            Welcome! Your OTP (One-Time Password) for registration email verification is:\n" +
                "        </p>\n" +
                "        \n" +
                ...
                "        </p>\n" +
                "        \n" +
                "        <div style=\"background-color: #e3f2fd; border-left: 4px solid #667eea; padding: 15px; margin: 20px 0; border-radius: 4px;\">\n"
                +
                "            <p style=\"color: #1565c0; margin: 0; font-size: 14px;\">\n" +
                "                <strong>ℹ️ Registration Verification:</strong> Please enter this OTP to complete your registration and activate your "
                + appName + " account.\n" +
                "            </p>\n" +
                "        </div>\n" +
                "        \n" +
                ...
                "                <strong>⚠️ Security Warning:</strong> Do not share this OTP with anyone. " + appName
                ...
                +
                "            If you didn't sign up for " + appName
     ...
     */
    private String buildForgotPasswordOtpEmailContent(String otp) {
        // Use string concatenation instead of .formatted() to avoid issues with CSS
        // color codes
        return "<html>\n" +
                "<body style=\"font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;\">\n" +
                ...
                +
                "        <div style=\"text-align: center; margin-bottom: 30px;\">\n" +
                "            <h1 style=\"color: #ff6b6b; margin: 0;\">" + appName + "</h1>\n" +
                "            <p style=\"color: #999; margin: 5px 0 0 0;\">Forgot Password OTP</p>\n" +
                "        </div>\n" +
                "        \n" +
                "        <div style=\"background-color: #ffe0e0; border-left: 4px solid #ff6b6b; padding: 15px; margin-bottom: 20px; border-radius: 4px;\">\n"
                +
                "            <p style=\"color: #c92a2a; margin: 0; font-size: 14px;\">\n" +
                "                <strong>🔐 Password Reset Request Received</strong>\n" +
                "            </p>\n" +
                "        </div>\n" +
                "        \n" +
                "        <p style=\"color: #333; font-size: 16px; margin-bottom: 20px;\">\n" +
                "            We received a request to reset your password. Your OTP (One-Time Password) for password reset is:\n"
                +
                "        </p>\n" +
                "        \n" +
                "        <div style=\"background-color: #f9f9f9; border: 2px dashed #ff6b6b; padding: 20px; text-align: center; margin-bottom: 20px; border-radius: 8px;\">\n"
                +
                "            <p style=\"font-size: 32px; font-weight: bold; color: #ff6b6b; margin: 0; letter-spacing: 5px;\">"
                + otp + "</p>\n" +
                "        </div>\n" +
                "        \n" +
                "        <p style=\"color: #666; font-size: 14px; margin: 20px 0;\">\n" +
                ...
                +
                "            <p style=\"color: #2e7d32; margin: 0; font-size: 14px;\">\n" +
                "                <strong>✓ Next Steps:</strong> Use this OTP to verify your identity and set a new password. You'll regain access to your "
                + appName + " account immediately.\n" +
                "            </p>\n" +
                "        </div>\n" +
                "        \n" +
                "        <p style=\"color: #999; font-size: 12px; margin-top: 30px; border-top: 1px solid #eee; padding-top: 20px;\">\n"
                +
                "            If you didn't request a password reset, please ignore this email and your account will remain secure. Contact our support team immediately if you suspect unauthorized access.\n"
                +
                "        </p>\n" +
                "        \n" +
                "        <p style=\"color: #999; font-size: 12px; margin-top: 10px;\">\n" +
     ...
     * 
     * @param recipientEmail - Email address to send confirmation to
     * @param userName       - User's name
     * @throws MessagingException           if email sending fails
     * @throws UnsupportedEncodingException if encoding is not supported
     */
    public void sendPasswordChangeEmail(String recipientEmail, String userName)
            throws MessagingException, UnsupportedEncodingException {
        MimeMessage message = mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
        ...
        String htmlContent = buildPasswordChangeEmailContent(userName);
        helper.setText(htmlContent, true);
     ...
     */
    private String buildPasswordChangeEmailContent(String userName) {
        // Use string concatenation instead of .formatted() to avoid issues with CSS
        // color codes
        return "<html>\n" +
                "<body style=\"font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;\">\n" +
                ...
                "            <p style=\"color: #999; margin: 5px 0 0 0;\">Password Changed</p>\n" +
                "        </div>\n" +
                "        \n" +
                ...
                "        </p>\n" +
                "        \n" +
                "        <p style=\"color: #555; font-size: 15px; margin: 15px 0; line-height: 1.6;\">\n" +
                "            This email confirms that your password for your " + appName
                + " account has been changed successfully. Your account is now secure with your new password.\n" +
                "        </p>\n" +
                "        \n" +
                "        <div style=\"background-color: #f0f4ff; border-left: 4px solid #667eea; padding: 15px; margin: 20px 0; border-radius: 4px;\">\n"
                +
                "            <p style=\"color: #1565c0; margin: 0; font-size: 14px;\">\n" +
                "                <strong>ℹ️ Account Security:</strong> This action was performed on your " + appName
                + " account. If you did not authorize this change, please contact our support team immediately.\n" +
                "            </p>\n" +
                "        </div>\n" +
                "        \n" +
                "        <div style=\"background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0; border-radius: 4px;\">\n"
                +
                "            <p style=\"color: #856404; margin: 0; font-size: 14px;\">\n" +
                "                <strong>💡 Pro Tip:</strong> Use a strong password with a mix of uppercase, lowercase, numbers, and special characters for better security.\n"
                +
                "            </p>\n" +
                "        </div>\n" +
                "        \n" +
                "        <p style=\"color: #999; font-size: 12px; margin-top: 30px; border-top: 1px solid #eee; padding-top: 20px;\">\n"
                +
                "            If you didn't change your password or suspect unauthorized access to your account, please contact our support team immediately.\n"
                +
                "        </p>\n" +
                "        \n" +
                "        <p style=\"color: #999; font-size: 12px; margin-top: 10px;\">\n" +
